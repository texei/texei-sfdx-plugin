...
<!-- commands -->
* [`sfdx texei:metadata:approvalprocess:replaceapprover [-p <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal]`](#sfdx-texeimetadataapprovalprocessreplaceapprover--p-string--u-string---apiversion-string---json---loglevel-tracedebuginfowarnerrorfatal)
* [`sfdx texei:package:dependencies:install [-k <string>] [-b <string>] [-p <string>] [-n <string>] [-w <number>] [-r] [-v <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal]`](#sfdx-texeipackagedependenciesinstall--k-string--b-string--p-string--n-string--w-number--r--v-string--u-string---apiversion-string---json---loglevel-tracedebuginfowarnerrorfatal)
* [`sfdx texei:user:update [-v <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal]`](#sfdx-texeiuserupdate--v-string--u-string---apiversion-string---json---loglevel-tracedebuginfowarnerrorfatal)

## `sfdx texei:metadata:approvalprocess:replaceapprover [-p <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal]`

replace recipient in approval process' metadata

```
USAGE
  $ sfdx texei:metadata:approvalprocess:replaceapprover [-p <string>] [-u <string>] [--apiversion <string>] [--json] 
  [--loglevel trace|debug|info|warn|error|fatal]

OPTIONS
  -p, --path=path                                 path to approval process' metadata
...
EXAMPLE
  $ texei:metadata:approvalprocess:replacerecipient
```

_See code: [src\commands\texei\metadata\approvalprocess\replaceapprover.ts](https://github.com/texei/texei-sfdx-plugin/blob/v0.0.5/src\commands\texei\metadata\approvalprocess\replaceapprover.ts)_

## `sfdx texei:package:dependencies:install [-k <string>] [-b <string>] [-p <string>] [-n <string>] [-w <number>] [-r] [-v <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal]`
...
USAGE
  ...
  [-v <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal]
...
OPTIONS
  ...
  -p, --packages=packages                          comma-separated list of the packages to install related dependencies
...
_See code: [src\commands\texei\package\dependencies\install.ts](https://github.com/texei/texei-sfdx-plugin/blob/v0.0.5/src\commands\texei\package\dependencies\install.ts)_

## `sfdx texei:user:update [-v <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal]`
...
_See code: [src\commands\texei\user\update.ts](https://github.com/texei/texei-sfdx-plugin/blob/v0.0.5/src\commands\texei\user\update.ts)_
<!-- commandsstop -->
